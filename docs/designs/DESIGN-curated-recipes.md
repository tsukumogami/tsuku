...
| ~~_Curates the embedded recipes for make, ninja, and meson, and authors a new recipe for maven. Gradle and sbt deferred to #2325 (GitHub provider milestone-tag handling)._~~ | | |
