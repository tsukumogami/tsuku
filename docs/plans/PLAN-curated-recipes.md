...
| ~~_Authors new recipes for azure-cli, ansible, and argocd, and replaces the batch-generated recipe for bazel. Gcloud deferred to #2328 — Google Cloud SDK has no GitHub releases and tsuku has no version source for Google's distribution channel._~~ | | |
