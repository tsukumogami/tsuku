...
// ValidateStepsAgainstPlatforms validates that step mappings are consistent
// with the recipe's platform constraints.
//
...
// 3. when clause platform tuples and OS arrays
//
