...
func removeTestCtx() context.Context {
...
func TestRemoveVersion_Single(t *testing.T) {
	...
	err = mgr.RemoveVersion(removeTestCtx(), "mytool", "1.0.0")
	if err != nil {
...
func TestRemoveVersion_ActiveSwitchesToMostRecent(t *testing.T) {
	...
	err = mgr.RemoveVersion(removeTestCtx(), "mytool", "2.0.0")
	if err != nil {
		t.Fatalf("RemoveVersion() error = %v", err)
	}
...
func TestRemoveVersion_InvalidVersion(t *testing.T) {
	...
	for _, tc := range tests {
		t.Run(tc.name, func(t *testing.T) {
			err := mgr.RemoveVersion(removeTestCtx(), "sometool", tc.version)
			if err == nil {
...
func TestRemoveAllVersions(t *testing.T) {
	...
	// Remove all versions
	err = mgr.RemoveAllVersions(removeTestCtx(), "mytool")
	if err != nil {
...
func TestRemoveAllVersions_ToolNotInstalled(t *testing.T) {
	...
	err := mgr.RemoveAllVersions(removeTestCtx(), "nonexistent")
	if err == nil {
...
func TestRemoveVersion_EmptyBinariesFallback(t *testing.T) {
	...
	err = mgr.RemoveVersion(removeTestCtx(), "legacytool", "2.0.0")
	if err != nil {
		t.Fatalf("RemoveVersion() error = %v", err)
	}
...
func TestRemoveVersion_LegacyNoCleanupActions(t *testing.T) {
	...
	err = mgr.RemoveVersion(removeTestCtx(), "oldtool", "1.0.0")
	if err != nil {
		t.Fatalf("RemoveVersion() error = %v", err)
	}
...
func TestRemoveVersion_MultipleBinaries(t *testing.T) {
	...
	// Remove the tool
	err = mgr.RemoveVersion(removeTestCtx(), "multitool", "1.0.0")
	if err != nil {
		t.Fatalf("RemoveVersion() error = %v", err)
	}
