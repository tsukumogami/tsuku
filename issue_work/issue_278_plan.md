...
- [ ] Add Anthropic SDK dependency to go.mod
- [ ] Create `internal/llm/cost.go` with Usage struct and cost calculation
- [ ] Create `internal/llm/cost_test.go` with unit tests
